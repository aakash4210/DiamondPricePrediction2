...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            os.makedirs(os.path.dirname(self.ingestion_config.raw_data_path),exist_ok=True) #we make dir (artifict / under that creatd file -> raw.csv)
                                                                            #exist_ok : pehelese hoga to useme raw.csv banv , nihi hoda to new banv
            ...
            #if any error in try block this will handle it
